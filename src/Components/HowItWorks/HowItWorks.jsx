    ...
    return (
        <section className="max-w-6xl mx-auto px-4 py-12 space-y-8">
            <div className="text-center space-y-3">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900">Shop in three simple steps</h2>
                <p className="text-gray-600 max-w-2xl mx-auto">From browsing to delivery, we keep every step clear and effortless.</p>
            </div>
